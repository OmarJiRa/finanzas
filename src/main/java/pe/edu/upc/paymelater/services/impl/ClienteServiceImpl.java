...
import pe.edu.upc.paymelater.models.repositories.ClienteRepository;
...
public class ClienteServiceImpl implements ClienteService, Serializable{
	...
	@Transactional(readOnly = true)
	@Override
	public List<Cliente> findByNombresApellidosContaining(String nombresApellidos) throws Exception {
